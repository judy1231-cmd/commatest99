              ...
              <div className="flex items-center gap-2">
                ...
                >
                  {saving ? (
                    ...
                    <>
                      <span className="material-icons text-[16px]">publish</span>
                      발행하기
                    </>
                  )}
                </button>
                ...
                <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
                  ...
                  {form.durationMinutes && (
                    <p className="text-xs text-gray-400 mt-2">
                      약 <span className="font-semibold text-gray-600">{Math.floor(form.durationMinutes / 60) > 0 ? `${Math.floor(form.durationMinutes / 60)}시간 ` : ''}{form.durationMinutes % 60}분</span> 소요
                    </p>
                  )}
                </div>
