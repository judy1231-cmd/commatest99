          ...
          <div className="space-y-3">
            {[
              ...
              { name: 'Naver',   provider: 'naver',  ready: true, linkUrl: 'http://localhost:8080/api/auth/naver/link', icon: (
                <svg viewBox="0 0 24 24" className="w-5 h-5"><rect width="24" height="24" rx="5" fill="#03C75A"/><path fill="white" d="M7.5 6h3.3l2.7 4.2V6H16.5v12h-3.3L10.5 13.8V18H7.5V6z"/></svg>
              )},
