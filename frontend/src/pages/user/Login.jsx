        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-soft border border-slate-100 p-8">
            ...
            <div className="flex justify-center gap-4">
              <button className="w-12 h-12 flex items-center justify-center bg-white border border-slate-200 rounded-xl hover:bg-slate-50 transition-all shadow-sm">
              ...
              <button className="w-12 h-12 flex items-center justify-center bg-[#03C75A] hover:brightness-95 rounded-xl transition-all">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="white">
                  <path d="M16.273 12.845L7.376 0H0v24h7.727V11.155L16.624 24H24V0h-7.727z"/>
                </svg>
              </button>
              <button className="w-12 h-12 flex items-center justify-center bg-[#FEE500] hover:brightness-95 rounded-xl transition-all">
                <KakaoLogo />
              </button>
            </div>
