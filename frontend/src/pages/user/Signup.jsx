          ...
          <div className="mt-10">
            ...
            <div className="flex justify-center gap-4">
              ...
              <button
                ...
                className="w-12 h-12 rounded-xl bg-white border border-gray-200 hover:bg-gray-50 transition-all shadow-sm flex items-center justify-center"
              >
              ...
              <button
                ...
                className="w-12 h-12 rounded-xl bg-[#03C75A] hover:brightness-95 transition-all flex items-center justify-center"
              >
              ...
              <button
                ...
                className="w-12 h-12 rounded-xl bg-[#FEE500] hover:brightness-95 transition-all flex items-center justify-center"
              >
