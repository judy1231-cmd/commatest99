        ...
        <div className="w-full max-w-md py-12">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              <label className="text-[13px] font-bold text-slate-500 tracking-wide uppercase">이메일</label>
              <input
            ...
            <div className="flex justify-end pt-1">
              <Link to="/auth/find-password" className="text-[13px] text-slate-400 font-medium hover:text-primary transition-colors">
                비밀번호 찾기
              </Link>
            </div>
          ...
          <div className="space-y-3">
            <button className="w-full flex items-center gap-3 px-5 py-3.5 bg-white border border-slate-200 rounded-2xl hover:bg-slate-50 transition-all text-[14px] font-semibold text-slate-700">
            ...
            <button className="w-full flex items-center gap-3 px-5 py-3.5 bg-[#FEE500] hover:brightness-95 rounded-2xl transition-all text-[14px] font-semibold text-[#3c1e1e]">
              <KakaoLogo />
