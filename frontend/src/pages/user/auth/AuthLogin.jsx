      ...
      <main className="flex flex-col items-center justify-center min-h-[calc(100vh-64px)] px-6">
        <div className="w-full max-w-md py-12">
          ...
          <div className="space-y-3">
            <button className="w-full flex items-center px-5 py-3.5 bg-white border border-slate-200 rounded-2xl hover:bg-slate-50 transition-all text-[14px] font-semibold text-slate-700">
            ...
            <button className="w-full flex items-center px-5 py-3.5 bg-[#FEE500] hover:brightness-95 rounded-2xl transition-all text-[14px] font-semibold text-[#3c1e1e]">
              <KakaoLogo />
