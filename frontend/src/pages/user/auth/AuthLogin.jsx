      ...
      <main className="flex-1 flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            <div className="w-14 h-14 bg-primary rounded-full flex items-center justify-center mx-auto mb-4 shadow-sm overflow-hidden">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8">
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-end py-1">
                <Link to="/auth/find-password" className="text-sm text-slate-400 hover:text-primary transition-colors">
                  비밀번호 찾기
                </Link>
              </div>
            ...
            <p className="text-center mt-6 text-sm text-slate-400">
              아직 계정이 없으신가요?{' '}
              <Link to="/auth/signup" className="text-primary font-bold hover:underline">회원가입</Link>
            </p>
          </div>
