        ...
        <div className="w-full max-w-[520px] bg-white rounded-xl shadow-xl p-8 md:p-12 border border-primary/5">
          ...
          <div className="text-center mb-10">
            <div className="flex items-center justify-center gap-3 mb-3">
              <div className="w-10 h-10 bg-primary rounded-full flex items-center justify-center overflow-hidden shadow-sm shrink-0">
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-500">
              이미 계정이 있으신가요?
              <Link to="/auth/login" className="text-primary font-bold hover:underline ml-1">로그인하기</Link>
            </p>
          </div>
        </div>
      </main>
